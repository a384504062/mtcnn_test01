        ...
        for i, line in enumerate(open(anno_src)):
            ...
            try:
                ...
                with Image.open(image_file) as img:
                    ...
                    # for _ in range(5):
                    #     # '1.中心点改大一点，就有部分样本'
                    #     w_ = np.random.randint(-w * 0.4, w * 0.4)
                    #     h_ = np.random.randint(-h * 0.4, h * 0.4)
                    #     cx_ = cx + w_
                    #     cy_ = cy + h_
                    #
                    ...
                    #     '以上全是对原始标签、图像的处理'
                        ...
                        #             part_count, 2, offset_x1, offset_y1, offset_x2, offset_y2, offset_px1,offset_py1,
                        #               offset_px2, offset_py2, offset_px3, offset_py3, offset_px4, offset_py4, offset_px5, offset_py5
                        #         )
                        #     )
                    ...
                    for i in range(5):
                        ...
                        iou_ = utils.iou(crop_box, _boxes,isMin=True)
